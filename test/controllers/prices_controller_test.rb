...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { product_id: @price.product_id, purchase_price: @price.purchase_price, sale_price: @price.sale_price }
    end
  ...
  test "should update price" do
    patch :update, id: @price, price: { product_id: @price.product_id, purchase_price: @price.purchase_price, sale_price: @price.sale_price }
    assert_redirected_to price_path(assigns(:price))
  end
